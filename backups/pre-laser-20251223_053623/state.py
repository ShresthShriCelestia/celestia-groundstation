    ...
    async def update_laser_telemetry(self, laser_data: Dict):
        ...
        async with lock:
            ...
            self.telemetry.update({
                "laser_connected": laser_data.get("connection_status") == "Connected",
                "laser_output_power_w": laser_data.get("output_power_watts", 0.0),
                "laser_temperature_c": laser_data.get("temperature_c", 0.0),
                "laser_setpoint_pct": laser_data.get("setpoint_percent", 0.0),
